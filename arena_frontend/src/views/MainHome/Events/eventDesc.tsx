...
const EventPage: React.FC = () => {
  ...
  **Don't miss this opportunity to enhance your skills and expand your network!**
  ...
  const whatsappShareUrl = `whatsapp://send?text=${encodeURIComponent(eventDetails)}%20${eventUrl}`;
  const twitterShareUrl = `https://twitter.com/intent/tweet?text=${encodeURIComponent(eventDetails)}&url=${encodeURIComponent(eventUrl)}`;
  const linkedinShareUrl = `https://www.linkedin.com/shareArticle?mini=true&url=${encodeURIComponent(eventUrl)}&title=Event%20Title&summary=${encodeURIComponent(eventDetails)}`;
  const facebookShareUrl = `https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(eventUrl)}`;
  const locationUrl = "https://www.google.com/maps?q=1600+Amphitheatre+Parkway,+Mountain+View,+CA";
  return (
    <div style={{ marginTop:49}}>
      ...
      <Box p={3} sx={{ maxWidth: 1200, margin: 'auto',marginTop:'60px' }}>
        <Fade in timeout={1100}>
          ...
          <Card elevation={3} sx={{ p: 3, mb: 2 }} variant='outlined' style={{borderRadius:"0.5rem",boxShadow:" 0 4px 6px -1px rgba(0, 0, 0, 0.1) ,0 2px 4px -1px rgba(0, 0, 0, 0.06)"}}>
              ...
              <Grid item xs={12} md={7}>
                ...
                <Box display="flex" flexDirection="column" gap={2} mt={2}>
                  ...
                  <Box display="flex" alignItems="center" gap={1}>
                    ...
                    <Typography variant="body2" sx={{ fontWeight: 'bold', color: 'text.primary' }} onClick={() => window.open(locationUrl, "_blank")}>
                      {event.location}
                    </Typography>
                  </Box>
        ...
        <Fade in timeout={1200}>
          <Card elevation={3} sx={{ p: 3, mb: 3 }} style={{borderRadius:"0.5rem",boxShadow:" 0 4px 6px -1px rgba(0, 0, 0, 0.1) ,0 2px 4px -1px rgba(0, 0, 0, 0.06)"}} >
        ...
        <Fade in timeout={1400}>
          <Card style={{
            ...
            flexGrow: "1",
            overflowY: "auto",
            borderRadius:"0.5rem",boxShadow:" 0 4px 6px -1px rgba(0, 0, 0, 0.1) ,0 2px 4px -1px rgba(0, 0, 0, 0.06)"
          }} sx={{mb:3}}
          >
